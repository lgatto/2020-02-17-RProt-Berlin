...
![Root-mean-square error (RMSE) observations standard deviation ratio (RSR), KNN and MinDet imputation. Lower (blue) is better. (See [here](http://pubs.acs.org/doi/abs/10.1021/acs.jproteome.5b00981) for details)](./img/imp-sim.png)
...
**Exercise** Do you think we have any statistically differentially
expressed proteins?
...
If of interest, see [chapters 8, 9 and
10](https://uclouvain-cbio.github.io/WSBIM1322/sec-mlintro.html).
